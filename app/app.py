...
#             # Open the file and return the content of the specified line
#             with open(file_path, 'r') as file:
#                 for i, line in enumerate(file, 1):
#                     if i == line_number:
#                         return line
#             # If specified line number is not found, abort with a 404 error
#             return abort(404, description="Line not found")
#         except ValueError:
#             # If line number cannot be converted to an integer, abort with a 400 error
#             abort(400, description="Invalid line number")
#     else:
#         # If line number is not provided, return the entire file content
#         with open(file_path, 'r') as file:
#             return file.read()
